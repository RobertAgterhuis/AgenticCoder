...
MCP (Model Context Protocol) servers provide real-time Azure integration:
- **mcp-azure-pricing** - Query Azure pricing
- **mcp-azure-docs** - Search Azure documentation
- **mcp-azure-resource-graph** - Query Azure resources
