...
python health_check.py  # runs ping + price_search
```
...
- Retries: configurable backoff via env (see below).
...
- Health overrides: `AZURE_PRICING_HEALTH_SKU` (default Standard_B2s), `AZURE_PRICING_HEALTH_REGION`, `AZURE_PRICING_HEALTH_CURRENCY`
